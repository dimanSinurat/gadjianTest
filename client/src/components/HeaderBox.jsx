...
export default function HeaderBox({title, subTitle, buttonFor, searchFor}) {
  return (
        ...
        <div>
          <form method="GET">
            <div className="relative text-primary focus-within:text-gray-400">
              ...
              <input type="search" name="q" className="p-2 text-sm w-full rounded-sm border border-2 pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder={searchFor} autoComplete="off" />
            </div>
          </form>
        </div>
        {/* add button */}
